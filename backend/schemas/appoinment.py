...
class AppointmentAdd(BaseModel):
    ...
    doc_states: Optional[dict] = Field(..., description="Dictionary of document states required for the appointment")
    sub_service_state: Optional[str] = Field(..., description="State of the service (e.g., 'active', 'inactive')")
