...
class AppointmentAdd(BaseModel):
    ...
    appointment_date: Optional[datetime] = Field(default=None, description="Date and time of the appointment")
    appoinment_time: Optional[datetime] = Field(default=None, description="Time of the appointment")
    predicted_duration: Optional[datetime] = Field(default=None, description="Predicted duration of the appointment")
